...
BLOG_AUTHOR = "scd"  # (translatable)
BLOG_TITLE = "Supply Chain Planet"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://www.supplychainplanet.site/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://www.supplychainplanet.site/"
BLOG_EMAIL = "nagdantmathur@gmail.com"
BLOG_DESCRIPTION = "Supply Chain Blogs Planet Site"  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "supplychainplanet-site"
...
# before </head>
# (translatable)
EXTRA_HEAD_DATA = """<script type='text/javascript' data-cfasync='false' src='//dsms0mj1bbhn4.cloudfront.net/assets/pub/shareaholic.js' data-shr-siteid='12bd205855529a823a579d838a5e4a89' async='async'></script>"""
